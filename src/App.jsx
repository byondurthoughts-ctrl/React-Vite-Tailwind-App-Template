...
                    className="absolute top-4 right-4 z-10 p-2 bg-white/80 rounded-full hover:bg-white transition-colors text-2xl"
                  >
...
                    />
                  ) : (
                    // Fallback to emoji and gradient if no image is provided
